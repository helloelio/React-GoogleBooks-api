        ...
        <div className="book-items" key={props.bookId}>
                        ...
                        <div className="book">
                            ...
                            <div className="book__description">
                                <p className="book__categories">
                                    {_.get(book, 'volumeInfo.categories', '')}
                                </p>
                                <p className="book__title">
                                    {_.get(book, 'volumeInfo.title', '')}
                                </p>
                                <p className="book__authors">
                                    {_.get(book, 'volumeInfo.authors', '')}
                                </p>
                            </div>
                        </div>
                    </Link>
            ...
            <div className="load-button">
                {props.result.length > 0 && (
                    <button
                        onClick={props.handleLoadBooks}
                        className={`load-books ${props.loading}`}
                    >
                        Load more
                    </button>
                )}
